...
public protocol W3WAppleMapHelperProtocol {
  ...
  func addMarker(at square: W3WSquare?, color: W3WColor?, type: W3WMarkerType)
  func addMarker(at suggestion: W3WSuggestion?, color: W3WColor?, type: W3WMarkerType)
  func addMarker(at words: String?, color: W3WColor?, type: W3WMarkerType)
  func addMarker(at coordinates: CLLocationCoordinate2D?, color: W3WColor?, type: W3WMarkerType)
  func addMarker(at squares: [W3WSquare]?, color: W3WColor?, type: W3WMarkerType)
  func addMarker(at suggestions: [W3WSuggestion]?, color: W3WColor?, type: W3WMarkerType)
  func addMarker(at words: [String]?, color: W3WColor?, type: W3WMarkerType)
  func addMarker(at coordinates: [CLLocationCoordinate2D]?, color: W3WColor?, type: W3WMarkerType)
